...
## Probabilidades de extinção com valores de $r$ altos
...
Quando prolongamos para 60 dias esta simulação os resultados
não mudam muito:
...
e que a estocasticidade reduz as chances de coexistência.


## Probabilidades de extinção com valores de $r$ baixos
...
### Probabilidade de persistência com  estocasticidade
