...
## Probabilidades de persistência em cada estratégia

Abaixo a proporção das simulações em que cada população
persistiu (N >0), para cada combinação de estratégia

### Para duração do experimento 

```{r probs persistencias em cada comb de estrateg 11.3 dias}
...
```{r probs persistencias em cada comb de estrateg 30 dias}
