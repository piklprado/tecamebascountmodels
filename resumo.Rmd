...
kable(pops.m2, digits=3, caption="Posterior probabilities of Nash equilibrium for each combination of strategies. Probabilities calculated from simulations of the competition dynamics ran till 11.3 days. Payoff: mean relative population sizes at the end of simulations.")
```
...
é alta se usamos os valores de $r$ e $K$ dos experimentos de competição. A estocasticidade reduz esta probablidade. 
Se prolongamos ou tempo ou calculamos o equilíbrio vemos que a probabilidade de persistência é bem menor.
Estes resultados mostram que a coexistência nos experimentos é um transiente.
